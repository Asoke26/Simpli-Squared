...
join movie_info AS mi on (mi.info IN ('Sweden',   'Norway',  'Germany',  'Denmark', 'Swedish', 'Denish', 'Norwegian', 'German', 'English') AND mi.movie_id = t.id AND ml.movie_id = mi.movie_id AND S1.mc_movie_id = mi.movie_id AND S2.mk_movie_id = mi.movie_id );